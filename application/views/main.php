<table cellpadding="0" cellspacing="0" border="0" id="example">
	...
	<tfoot>
        <tr>        	
			<th id="filter_col0"  data-column="0"><span  class="column_filter" id="col0_filter"></span></th>
			<th id="filter_col1"  data-column="1"><input type="text"  class="column_filter" id="col1_filter"></th>
            <th id="filter_col2"  data-column="2"><input type="text"  class="column_filter" id="col2_filter"></th>
            <th id="filter_col3"  data-column="3"><input type="text"  class="column_filter" id="col3_filter"></th>
            <th id="filter_col4"  data-column="4"><input type="text"  class="column_filter" id="col4_filter"></th>
            <th id="filter_col5"  data-column="5"><input type="text"  class="column_filter" id="col5_filter"></th>
            <th id="filter_col6"  data-column="6"><input type="text"  class="column_filter" id="col6_filter"></th>
            <th id="filter_col7"  data-column="7"><input type="text"  class="column_filter" id="col7_filter"></th>
            <th id="filter_col8"  data-column="8"><input type="text"  class="column_filter" id="col8_filter"></th>
            <th id="filter_col9"  data-column="9"><input type="text"  class="column_filter" id="col9_filter"></th>
            <th id="filter_col10" data-column="10"><input type="text" class="column_filter" id="col10_filter"></th>
            <th id="filter_col11" data-column="11"><input type="text" class="column_filter" id="col11_filter"></th>
            <th id="filter_col12" data-column="12"><span  class="column_filter" id="col12_filter"></span></th>
        </tr>
    </tfoot>
</table>
